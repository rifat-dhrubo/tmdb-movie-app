...
import { PRESET_YEARS } from '@/features/discover/constants';
import { cn } from '@/lib/utils';

interface DiscoverFilterBarYearFilterProps {
	onChange: (year: string | undefined) => void;
	value: string | undefined;
}

export function DiscoverFilterBarYearFilter({
	onChange,
	value,
}: DiscoverFilterBarYearFilterProps) {
